        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <div className="mt-10 flex gap-4">
              <a
                href="https://wa.me/38164386369?text=Zdravo!%20Zanima%20me%20ponuda%20Zenit%20mikrobilja%20i%20funkcionalnih%20sokova."
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl bg-green-500 px-6 py-4 font-semibold text-black transition hover:bg-green-400"
              >
                📱 Poruči odmah
              </a>
